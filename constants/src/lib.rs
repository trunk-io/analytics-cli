...
pub const TRUNK_FORK_REPO_URL_ENV: &str = "TRUNK_FORK_REPO_URL";
...
pub const TRUNK_PR_NUMBER_ENV: &str = "TRUNK_PR_NUMBER";
...
pub const TRUNK_CODEOWNERS_TYPE_ENV: &str = "TRUNK_CODEOWNERS_TYPE";
pub const TRUNK_CODEOWNERS_USE_BAZEL_TARGET_ENV: &str = "TRUNK_CODEOWNERS_USE_BAZEL_TARGET";
pub const TRUNK_VARIANT_ENV: &str = "TRUNK_VARIANT";
pub const TRUNK_USE_UNCLONED_REPO_ENV: &str = "TRUNK_USE_UNCLONED_REPO";
pub const TRUNK_DISABLE_QUARANTINING_ENV: &str = "TRUNK_DISABLE_QUARANTINING";
pub const TRUNK_ALLOW_EMPTY_TEST_RESULTS_ENV: &str = "TRUNK_ALLOW_EMPTY_TEST_RESULTS";
pub const TRUNK_DRY_RUN_ENV: &str = "TRUNK_DRY_RUN";
...
pub const ENVS_TO_GET: &[&str] = &[
    ...
    "bamboo_planName",
    "bamboo_shortPlanName",
    "bamboo_shortJobName",
    "bamboo_buildTimeStamp",
    "bamboo_agentId",
    "bamboo_triggerReason_key",
    "bamboo_planRepository_branch",
    "bamboo_planRepository_branchName",
    "bamboo_planRepository_revision",
    "bamboo_planRepository_repositoryUrl",
    "bamboo_repository_pr_key",
    "bamboo_planRepository_username",
    // Google Cloud Build (not automatically provided, must be set in yaml config)
    "PROJECT_ID",
    "BUILD_ID",
    "PROJECT_NUMBER",
    "LOCATION",
    ...
    "TAG_NAME",
    "REF_NAME",
    // Google Cloud Build triggered by GitHub PR (also not automatically provided)
    "_HEAD_BRANCH",
    "_BASE_BRANCH",
    "_HEAD_REPO_URL",
    "_PR_NUMBER",
